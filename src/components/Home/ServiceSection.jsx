...
​`,
  ...
  },
  {
    ...
    desc: `The repair a vehicle's engine, transmission, brakes, suspension, and other vital components`,
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[75%] mx-auto mt-18 h-45 object-cover"
                    onError={(e) => {
