...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Local garage that we always use. Super friendly staff, experts in all vehicles. Prices are really competitive if not some of the cheapest around. All work carried out is to a very high standard that you would expect from a main dealer. Highly recommend this place for all car repairs and MOTs.",
    name: "Dean Kibble",
  },
